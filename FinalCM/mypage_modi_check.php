                ...
                <div class="card-grid active">
                    <div class="mypage-layout">
                        ...
                        <div class="mypage-subnav">
                            선택하신 음식의 이름 : <?php echo $Iname ?>
                        </div>


                        <input type="hidden" name="_csrf" value="2a06285c-ae7a-45e2-b4d6-60a3c9c7db89">

                        <form action="mypage_modi_modification.php" method="POST">
                            <input  type="hidden" name='Iname' value=<?php echo $Iname ?>>
                            <br>
                            수량 변경 : <input type="text" name='num'>
                            <input type = "submit" value="수정" onclick="window.location = 'mypage_modi_modification.php';"/>
