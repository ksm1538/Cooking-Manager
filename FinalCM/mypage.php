                    ...
                    <div class="board-head">
                        <ul>
                            <li class="board-title">
                                <span class="board-icon">Mypage</span>
...
try {
    ...
    foreach ($rows as $rs) /* name, userid, phone */ {
        $Fname = $rs['Iname'];
        $Fnum = $rs['Inum'];
        echo "<tr><th>$Fname</th><td>$Fnum</td></tr>";
    }
} catch (PDOException $e) {
    echo "Error: " . $e->getMessage();
}
...
?>
                        ...
                        <div class="form-button-region">
                            <button type="submit" class="button-lg button-blue" onclick="location.href = 'mypage_modi.php'">수정</button>
                            <button type="button" class="button-lg button-blue" onclick="location.href = 'mypage_plus.php'">추가</button>
                        </div>
